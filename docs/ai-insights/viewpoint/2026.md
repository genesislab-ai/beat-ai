...
#### 2026年3月
- [How to 10x your Claude Skills (using Karpathy's autoresearch method)](https://x.com/itsolelehmann/status/2033919415771713715) 一条把 autoresearch 方法讲得很透的长帖，核心是让智能体自己进入“修改-测试-评分-保留/回滚”的循环，把 Skill 从偶尔好用打磨成稳定好用。
- [如何把 Claude Skills 的效果提升 10 倍：用 Karpathy 的 autoresearch 方法自动打磨（站内中文翻译版）](/docs/ai-insights/viewpoint/how-to-10x-your-claude-skills.md) 这篇版本尽量保留了作者原帖的第一人称表达与论证顺序，把 Skill 优化讲成了一条可重复、可打分、可回滚的实验流程。
