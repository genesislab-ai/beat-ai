...
1、[Zh] [Rust 发布 1.62 版本](https://beatai.org/rust-course/appendix/rust-versions/1.62)

如果大家期待 Rust 像其它语言一样，每一个新版本都带来大量新特性，那你们可要失望了，1.62 的更新内容相当少，甚至不如某些语言一个 minor 版本的更新力度，但**错不在 Rust**，建议大家了解下 Rust 的[版本发布流程](https://beatai.org/rust-course/appendix/rust-version)，就明白其中的弯弯绕绕了。
